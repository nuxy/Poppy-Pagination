...
{<img src="https://github.com/nuxy/Poppy-Pagination/raw/master/preview.jpg" alt="Poppy-Pagination" />}[https://labs.mbrooks.info/demos/Poppy-Pagination]
...
- Fast and lightweight (jQuery plug-in *only 4.3 kB)

== Installation

Download the latest {sources}[https://github.com/nuxy/Poppy-Pagination/tags] and refer to the {README}[https://labs.mbrooks.info/demos/Poppy-Pagination/README.html] for more information about this package.
